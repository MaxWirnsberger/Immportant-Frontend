...
export const ForestryArea = forwardRef<FormHandle, AreaDataFormProps>(
      ...
      const fetchData = async () => {
        try {
          ...
          const formData: AreaDataFormValues = {
            ...
            heated_area: data.area?.garden_area || null,
      ...
      <FormProvider {...methods}>
        <div className={styles.form}>
          ...
          <div>
            ...
            <div className={styles.formGroupRow}>
              <div className={styles.formGroup}>
                <Label className={styles.formLabel}>Beheizbarefläche (m²)</Label>
                <Controller
                  name="heated_area"
                  control={control}
                  render={({ field }) => (

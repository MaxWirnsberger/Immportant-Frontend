...
import CommercialAmenitiesComponent from "../DetailsComponents/CommercialAmenitiesComponent";
...
export const OfficeDetails = forwardRef<
  FormHandle,
  DetailDataFormProps

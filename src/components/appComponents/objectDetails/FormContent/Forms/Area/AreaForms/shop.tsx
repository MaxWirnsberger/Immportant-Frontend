...
export const ShopArea = forwardRef<FormHandle, AreaDataFormProps>(
      ...
      const fetchData = async () => {
        try {
          ...
          const formData: AreaDataFormValues = {
            ...
            shop_area: data.area?.shop_area,
            sales_area: data.area?.sales_area,
            ...
            window_frontage: data.area?.window_frontage || null,
          ...
          await handleSubmit(async (formData) => {
            const nestedData = {
              area: {
                ...
                shop_area: formData.shop_area,
                sales_area: formData.sales_area,
                ...
                window_frontage: formData.window_frontage,
        ...
        <div className={styles.form}>
          <div className={styles.formSection}>
            <div className={styles.formGroupRow}>
              ...
              <div className={styles.formGroup}>
                <Label className={styles.formLabel}>Ladenfläche (m²)</Label>
                <Controller
                  name="shop_area"
                  control={control}
                  render={({ field }) => (
              ...
              <div className={styles.formGroup}>
                <Label className={styles.formLabel}>Verkaufsläche (m²)</Label>
                <Controller
                  name="sales_area"
                  control={control}
                  render={({ field }) => (
          ...
          <div>
            ...
            <div className={styles.formGroupRow}>
              ...
              <div className={styles.formGroup}>
                <Label className={styles.formLabel}>Fensterfront (m²)</Label>
                <Controller
                  name="window_frontage"
                  control={control}
                  render={({ field }) => (
                    <Input
                      id="window_frontage"

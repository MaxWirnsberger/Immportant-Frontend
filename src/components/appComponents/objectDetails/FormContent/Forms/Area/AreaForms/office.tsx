...
export const OfficeArea = forwardRef<FormHandle, AreaDataFormProps>(
      ...
      const fetchData = async () => {
        try {
          ...
          const formData: AreaDataFormValues = {
            ...
            office_area: data.area?.office_area,
          ...
          await handleSubmit(async (formData) => {
            const nestedData = {
              area: {
                ...
                office_area: formData.office_area,
        ...
        <div className={styles.form}>
          <div className={styles.formSection}>
            <div className={styles.formGroupRow}>
              ...
              <div className={styles.formGroup}>
                <Label className={styles.formLabel}>Bürofläche (m²)</Label>
                <Controller
                  name="office_area"
                  control={control}
                  render={({ field }) => (

...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      "peer inline-flex h-8 w-16 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors",
      ...
      "data-[state=checked]:bg-[#2cf599] data-[state=unchecked]:bg-gray-200",
      className
    )}
    {...props}
    ref={ref}
